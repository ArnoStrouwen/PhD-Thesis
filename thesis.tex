...
\documentclass[print,faculty=fbiw,department=bsy,doctoralschool=ads]{adsphd}
...
%%% COVER: Settings %%%
\title{Optimal Design of\\Dynamic Experiments\\in Bioscience Engineering}
...
\include{chapters/BeknopteSamenvatting}
\include{chapters/AbbreviationNomenclature}
\tableofcontents
\vspace*{-1cm}
\listoffigures
\listoftables
...
\include{chapters/OverarchingConclusion}
